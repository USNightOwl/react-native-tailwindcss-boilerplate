...
import { Onboarding3ScreenName } from "./onboarding";
...
const Onboarding4Screen = () => {
  ...
  return (
    <OnboardingLayout>
      <View>
        <Image source={require("../../../assets/images/onboarding/onboarding_4.png")} />
      </View>
      <View style={tw`px-4 w-full absolute bottom-10 flex-row justify-between`}>
        <ButtonDefault className="bg-transparent" func={() => navigation.navigate(Onboarding3ScreenName)}>
          <ChevronLeftIcon strokeWidth={2} color="#3355AC" />
          <Text style={tw`text-[#3355AC]`}>Quay lại</Text>
        </ButtonDefault>

        <ButtonDefault func={() => navigation.navigate(SignInScreenName)}>
          <Text style={tw`text-white`}>Hoàn thành</Text>
